...
<body>
  ...
  <header class="navbar navbar-dark sticky-t ;op bg-dark flex-md-nowrap p-0 shadow">
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <h2>All Blogs</h2>
        <form action="/pages/home/<?php echo $data["role"]?>" method="post">
        <input class="btn btn-primary" id="edit" type="submit" name="" value="Click to go to Blogs">
        </form>
        <br> <br>
        <h2>Add New Blog</h2>
        <form action="/pages/newBlog/<?php echo $data["user_id"]?>" method="post">
        <input type="hidden" name="myId" value = <?php echo $data["user_id"]?> >
