      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="blogId" id="prodID" value="<?php echo $data["id"]; ?>">
            <div class="col-md-6">
            <label for="pname" class="form-label">Title</label>
            <input type="text" class="form-control" id="pname" name="pname" required value="<?php echo $data["title"]; ?>">
          </div>
          <div class="col-md-6">
            <label for="list" class="form-label">Text</label>
           <textarea name="blogText" id="list" cols="60"  rows="10"><?php echo $data["text"]; ?></textarea>
          </div>
          <div class="col-md-6">
            <label for="list" class="form-label">Image</label>
            <input type="file" name="c_image" value="<?php echo $data["img"] ?>"  /><img src="../../../public/images/<?php echo $data["img"] ?>" width="150px" height="100px">
          </div>
